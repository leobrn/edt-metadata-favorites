...
- добавление в избранное [проектов](docs/user-guide.md#на-проекте-конфигурации),
  [отдельных объектов метаданных](docs/user-guide.md#на-объекте-метаданных) и объектов
  [прямо из открытого редактора](docs/user-guide.md#из-открытого-редактора-объекта);
...
- [визуальная отметка](docs/user-guide.md#значки-избранного-в-дереве) избранных элементов;
- [автоматическая очистка](docs/user-guide.md#форма-управления-избранным) ссылок на удалённые объекты;
